...
a|icon:lock[title=Fixed at build time] [[quarkus-zeebe_quarkus.zeebe.devservices.watch-bpmn-dir]]`link:#quarkus-zeebe_quarkus.zeebe.devservices.watch-bpmn-dir[quarkus.zeebe.devservices.watch-bpmn-dir]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_ZEEBE_DEVSERVICES_WATCH_BPMN_DIR+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_ZEEBE_DEVSERVICES_WATCH_BPMN_DIR+++`
endif::add-copy-button-to-env-var[]
--|boolean 
|`true`
