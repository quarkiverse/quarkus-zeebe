    ...
    render() {
        return html`
            <vaadin-tabs theme="equal-width-tabs" selected="${this._tab}">
                ...
                <vaadin-tab id="user-tasks" @click=${() => this._navbar("user-tasks")}>User tasks</vaadin-tab>
            </vaadin-tabs>
            ...
            ${choose(this._nav, [
                ...
                ['user-tasks', () => html`<zeebe-user-tasks .context=${this._context} .navigation=${(request) => this.navigation(request)}></zeebe-user-tasks>`],    
            ],
